...
const D3Farmer = () => {
	...
	const handleBackClick = () => {
		navigate("/d2farmer"); // Navigate back to D2Farmer component
	};

	const handleNextClick = () => {
		navigate("/d4farmer"); // Navigate to D4Farmer component
	};
		...
		<div className="d-3-farmer">
			<section className="personalization">
				...
				<div className="navigation">
					<button
						className="back-button-container-parent"
					...
					<button className="next-parent" onClick={handleNextClick}>
