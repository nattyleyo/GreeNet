  ...
  return (
    <div className="sidebar">
      ...
      <ul className="sidebar-menu">
        <Link className="sidebar-item" to="/overview">
          <li>
            <svg
              // style={{ stroke: "white" }}
              width="21"
        ...
        <Link className="sidebar-item" to="/market-data">
          <li>
            <svg
              width="21"
              height="22"
        ...
        <Link className="sidebar-item" to="/wheather">
          <li>
            <svg
              width="23"
              height="23"
        ...
        <Link className="sidebar-item" to="/map">
          <li>
            <svg
              width="21"
              height="22"
        ...
        <Link className="sidebar-item" to="/community">
          <li>
            <svg
              width="21"
              height="22"
