...
const D4Farmer = () => {
	...
	const handleBackClick = () => {
		// Navigate back to D3Farmer component or route
		navigate(-1); // Go back to previous location
	};

	const handleFinishClick = () => {
		// Navigate to Home component or route
		navigate("/"); // Navigate to Home component or route
	};
		...
		<div className="d-4-farmer">
			<div className="personalization">
				...
				<div className="frame-parent7">
					<button className="right-1-group" onClick={handleBackClick}>
						<img className="right-1-icon" alt="" src={left} />
						<div className="maize">Back</div>
					</button>
					<button className="finish-parent" onClick={handleFinishClick}>
